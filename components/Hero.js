        ...
        >
          <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
            <h1 className="text-3xl lg:text-4xl xl:text-5xl font-medium text-black-600 leading-normal">
              More Smiles, More Stays, More Success with{" "}
              <strong>WeEngage</strong>.
            </h1>
            <p className="text-black-500 mt-4 mb-6">
              At WeEngage, we empower independent hotels with AI-driven guest
              reward and loyalty solutions designed to enhance the guest
          ...
          <div className="flex w-full">
            <motion.div
              className="md:h-full h-[140px] w-full"
              variants={scrollAnimation}
            >
              <Image
